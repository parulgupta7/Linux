# Linux
  ...
  * See project live at: [link][http://ec2-34-206-72-18.compute-1.amazonaws.com]

#### Notes for reviewer:
  * Public IP: 34.206.72.18
  * SSH PORT: 2200
  * Full project URL: [link][http://ec2-34-206-72-18.compute-1.amazonaws.com]
...
* Configure And Enable New Virtual Host
    ...
    * Paste the following:
    ```
    <VirtualHost *:80>
      ServerName 34.206.72.18
      ServerAdmin admin@34.206.72.18
...
* Clone Github Repo
    * `sudo git clone https://github.com/parulgupta7/restaurants_database.git`
...
[project url]: ec2-34-206-72-18.compute-1.amazonaws.com
